         ...
         <div class="row">
            <div class="col-md-6">
               <div class="about_taital_main">
                  ...
                  <p class="about_text">Sistem Informasi Geografis (SIG) atau Geographic Information System (GIS) adalah sistem informasi pemetaan berbasis komputer yang digunakan untuk memasukkan, menyimpan, memanggil kembali, mengolah, menganalisis dan menghasilkan data bereferensi geografis atau data geospatial, untuk mendukung pengambilan keputusan dalam perencanaan dan pengelolaan penggunaan lahan, sumber daya alam, lingkungan, transportasi, fasilitas kota, dan pelayanan umum lainnya. Teknologi Sistem Informasi Geografis juga dapat digunakan untuk investigasi ilmiah, pengelolaan sumber daya, perencanaan pembangunan, kartografi dan perencanaan rute. Hasil akhir dari proses GIS diwujudkan dalam peta atau grafik. Peta sangatlah efektif untuk menyimpan, memvisualisasikan dan memberikan informasi geografis.  </p>
                  <div class="readmore_bt"><a href="view.php">View Penginapan</a></div>
               </div>
            </div>
            <div class="col-mb-5">
               <div><img src="../img/penginapan.jpg" alt="" style="height: 600px;width: 700px;"></div>
            </div>
         </div>
      </div>
   </div>
